import CardCategoryBox1 from "../../Cards/CardCategoryBox1";
...
const GridCategoryBoxSection: React.FC<SectionGridCategoryBoxProps> = ({
...
export default GridCategoryBoxSection;
