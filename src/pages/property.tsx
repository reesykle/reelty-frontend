...
import LikeSaveBtns from "../shared/Modal/LikeSaveBtns";
import ModalPhotos from "../shared/Modal/ModalPhotos";
...
const Property: FC<ListingStayDetailPageProps> = ({className = "",isPreviewMode,}) => {
    ...
    const renderSection1 = () => {
        return (
            ...
            <span className="ml-1"> Miami, USA</span>
          </span>
                </div>
                ...
                <div className="flex items-center justify-between xl:justify-start space-x-8 xl:space-x-12 text-sm text-neutral-700 dark:text-neutral-300">
                    <div className="flex items-center space-x-3">
                        ...
                        <span className=" ">2 <span className="hidden sm:inline-block">bedrooms</span></span>
                    </div>
                    <div className="flex items-center space-x-3">
                        <i className="las la-bath text-2xl"></i>
                        <span className=" ">3 <span className="hidden sm:inline-block">bathrooms</span></span>
                    </div>
                    <div className="flex items-center space-x-3">
                        <i className="las la-expand-arrows-alt text-lg"></i>
                        <span className=" "><span className="hidden sm:inline-block">1,200 SQ. FT</span></span>
                    </div>
                </div>
            </div>
        );
        ...
        return (
            <div className="listingSection__wrap">
                ...
                <div className="text-neutral-6000 dark:text-neutral-300">
                    <span>
                    Lorem Ipsum. This is a great property located in Miami Florida, near the beautiful beaches.
                    </span>
                </div>
            </div>
        );
    ...
    const renderSection4 = () => {
        return (
            <div className="listingSection__wrap">
                {/* HEADING */}
                <div>
                    <h2 className="text-2xl font-semibold">Real Time Investments </h2>
                    <span className="block mt-2 text-neutral-500 dark:text-neutral-400">
                ...
                <div className="flow-root">
                    <div className="text-sm sm:text-base text-neutral-6000 dark:text-neutral-300 -mb-4">
                        <div className="p-4 bg-neutral-100 dark:bg-neutral-800 flex justify-between items-center space-x-4 rounded-lg">
                            <span>0x72b61c6014342d914470eC7aC2975bE345796555</span>
                            <span>500B SYCLE</span>
                        </div>
                        ...
                        <div className="p-4 flex justify-between items-center space-x-4 rounded-lg">
                            <span>0x72b61c6014342d914470eC7aC2975bE345796555</span>
                            <span>780B SYCLE</span>
                        </div>
                        <div className="p-4 bg-neutral-100 dark:bg-neutral-800 flex justify-between items-center space-x-4 rounded-lg">
                            <span>0x72b61c6014342d914470eC7aC2975bE345796555</span>
                            <span>900B SYCLE</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    const renderSection8 = () => {
        return (
            <div className="listingSection__wrap">
                {/* HEADING */}
                <h2 className="text-2xl font-semibold">Remodeling Details</h2>
                <div className="w-14 border-b border-neutral-200 dark:border-neutral-700" />
                ...
                <div>
                    ...
                    <span className="block mt-3 text-neutral-500 dark:text-neutral-400">
                        Here's how this property will be remodeled to meet our sustainability requirements.
                    </span>
                    <br/>
                    <ul>
                        <li>Solar Panels</li>
        ...
        return (
          ...
          <span className="text-3xl font-semibold">
            20T SYCLE
                ...
                {/* SUBMIT */}
                <ButtonPrimary>Invest</ButtonPrimary>
            </div>
        );
    };
